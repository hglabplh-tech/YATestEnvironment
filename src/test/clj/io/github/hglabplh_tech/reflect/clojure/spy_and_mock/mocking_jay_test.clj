(ns ie.harald.g.p.it-cons.test.suite.spy-and-mock.mocking-jay-test
...
(deftest test-extended-mock
  (testing "the extended mock"
    ...
    (mock ie.harald.g.p.it-cons.test.suite.spy-and-mock.mocking-jay-test)
...
(deftest test-simple-spy
  (testing "A simple test for spy functionality"
    (spy ie.harald.g.p.it-cons.test.suite.spy-and-mock.mocking-jay-test)
...
(deftest test-example-spy
  (testing "A simple test for spy functionality"
    (spy ie.harald.g.p.it-cons.test.suite.example.the-funs-ns)
