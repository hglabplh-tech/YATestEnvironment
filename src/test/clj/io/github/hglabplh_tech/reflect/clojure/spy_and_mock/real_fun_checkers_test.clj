(ns ie.harald.g.p.it-cons.test.suite.spy-and-mock.real-fun-checkers-test
...
(deftest test-meta-of-fun
  ...
  (testing "the meta values of a function defn / fn"
    (is (= (.toString (get-fun-meta-ns testit))
           "ie.harald.g.p.it-cons.test.suite.spy-and-mock.real-fun-checkers-test"))
    (is (= (get-fun-meta-ns-sym testit)
           'ie.harald.g.p.it-cons.test.suite.spy-and-mock.real-fun-checkers-test))
