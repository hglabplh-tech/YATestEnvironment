...
package io.github.hglabplh_tech.reflect.java.api.example.annot_rec;
...
public class AnnotTestClass extends AnnotTestBase implements HumanResource {
    ...
    @io.github.hglabplh_tech.reflect.java.api.example.annot_rec.TransportSpec(transportType = io.github.hglabplh_tech.reflect.java.api.example.annot_rec.TransportSpec.TransportType.PIPE,
    sourceType = Category.class, targetType = StringBuilder.class)
    public EmployeeType emplType() {
        return emplType;
    }

    @io.github.hglabplh_tech.reflect.java.api.example.annot_rec.TransportSpec(transportType = TransportSpec.TransportType.HTTP)
    public String name() {
        return name;
    }
}
